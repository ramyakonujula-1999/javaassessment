...
public class LRUCache {
	...
	Entry start, end;
	int LRU_SIZE = 3; // Here i am setting 3 to test the LRU cache
	...
	public static void main(String[] args) throws java.lang.Exception {
		...
		lrucache.putEntry(1, 3);
		lrucache.putEntry(4, 2);
		lrucache.putEntry(5, 6);
		lrucache.putEntry(7, 4);
        
	
		System.out.println(lrucache.getEntry(1));
		System.out.println(lrucache.getEntry(7));
